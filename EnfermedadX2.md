...
par[1] 4.984   0.012 0.950 3.315 4.312 4.918 5.602 7.019  6358    1
par[2] 0.625   0.002 0.126 0.402 0.537 0.616 0.706 0.891  6281    1

Samples were drawn using NUTS(diag_e) at Fri Dec  8 01:49:03 2023.
...
post-warmup draws per chain=2000, total post-warmup draws=8000.
        ...
        mean se_mean    sd  2.5%   25%   50%   75% 97.5% n_eff Rhat
par[1] 1.970   0.001 0.076 1.824 1.919 1.970 2.022 2.123  9358    1
par[2] 0.538   0.001 0.058 0.440 0.497 0.533 0.573 0.668  9032    1

Samples were drawn using NUTS(diag_e) at Fri Dec  8 01:49:10 2023.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
```
...
post-warmup draws per chain=2000, total post-warmup draws=8000.
        ...
        mean se_mean    sd  2.5%   25%   50%   75%  97.5% n_eff Rhat
par[1] 2.588   0.003 0.292 2.042 2.383 2.580 2.778  3.188  9851    1
par[2] 9.062   0.006 0.532 8.054 8.699 9.046 9.428 10.135  8488    1

Samples were drawn using NUTS(diag_e) at Fri Dec  8 01:48:55 2023.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
```
...
Estimate 264.87555 270.2084 279.82300
SE         9.05841  12.1596  14.54172
```
...
```{.output}
       weibull    gamma lognormal
2.5%  7.138306 7.032424  7.146906
50%   8.040662 7.978298  8.271934
97.5% 9.012610 9.110162  9.892146
```
...
```{.output}
       weibull    gamma lognormal
2.5%  2.815312 2.927375  3.546649
50%   3.340590 3.597797  4.722425
97.5% 4.143135 4.584874  6.916507
```
...
2.5%  1.410735 1.991019 6.842088 12.40271 13.37039 14.44698
50%   2.174520 2.860430 7.854130 13.83964 14.99460 16.35043
97.5% 3.007499 3.762050 8.845569 15.95032 17.55424 19.42479
```
...
```{.output}
         0.025     0.05      0.5     0.95    0.975     0.99
2.5%  1.772828 2.287713 6.507373 12.75468 14.14652 15.85955
50%   2.568150 3.124826 7.440706 14.64779 16.41017 18.61634
97.5% 3.307316 3.881242 8.486710 17.44085 19.76240 22.68713
```
...
```{.output}
         0.025     0.05      0.5     0.95    0.975     0.99
2.5%  1.867700 2.288185 6.198697 14.07882 16.30502 19.25110
50%   2.527875 2.987643 7.170399 17.20984 20.34661 24.73874
97.5% 3.165775 3.663997 8.359276 22.55922 27.61641 35.08930
```
