...
par[1] 4.986   0.014 0.949 3.308 4.326 4.935 5.575 7.047  4663    1
par[2] 0.627   0.002 0.125 0.406 0.539 0.619 0.708 0.892  4754    1

Samples were drawn using NUTS(diag_e) at Tue Mar 12 02:01:49 2024.
...
post-warmup draws per chain=2000, total post-warmup draws=8000.
        ...
        mean se_mean    sd  2.5%   25%   50%   75% 97.5% n_eff Rhat
par[1] 1.971   0.001 0.075 1.822 1.921 1.970 2.021 2.119  9469    1
par[2] 0.538   0.001 0.057 0.441 0.499 0.533 0.572 0.663  9932    1

Samples were drawn using NUTS(diag_e) at Tue Mar 12 02:01:56 2024.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
```
...
post-warmup draws per chain=2000, total post-warmup draws=8000.
        ...
        mean se_mean    sd  2.5%   25%   50%  75%  97.5% n_eff Rhat
par[1] 2.596   0.003 0.284 2.056 2.404 2.584 2.78  3.182  9298    1
par[2] 9.071   0.005 0.524 8.082 8.712 9.056 9.41 10.155  9673    1

Samples were drawn using NUTS(diag_e) at Tue Mar 12 02:01:40 2024.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
```
...
Estimate 264.668529 270.20523 279.49094
SE         9.057392  12.19047  14.39574
```
...
```{.output}
       weibull    gamma lognormal
2.5%  7.170705 7.061386  7.137586
50%   8.049600 7.961051  8.272855
97.5% 9.030442 9.078749  9.842594
```
...
```{.output}
       weibull    gamma lognormal
2.5%  2.803802 2.924367  3.534925
50%   3.326589 3.580594  4.731918
97.5% 4.136930 4.576985  6.843798
```
...
2.5%  1.453256 2.039932 6.901455 12.41749 13.37181 14.42035
50%   2.185230 2.870583 7.859648 13.81752 14.97111 16.30630
97.5% 2.985784 3.734627 8.868352 16.03017 17.59553 19.46382
```
...
```{.output}
         0.025     0.05      0.5     0.95    0.975     0.99
2.5%  1.767541 2.275260 6.523456 12.71246 14.11006 15.84597
50%   2.561219 3.116039 7.428377 14.60675 16.36425 18.56056
97.5% 3.293609 3.863506 8.435299 17.46366 19.80739 22.80376
```
...
```{.output}
         0.025     0.05      0.5     0.95    0.975     0.99
2.5%  1.870661 2.288804 6.184947 14.04894 16.24738 19.22953
50%   2.526648 2.988865 7.173364 17.23958 20.39594 24.79502
97.5% 3.154389 3.658933 8.323958 22.41365 27.41372 34.71942
```
