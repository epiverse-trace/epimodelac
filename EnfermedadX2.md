...
par[1] 4.977   0.012 0.945 3.324 4.307 4.914 5.579 7.016  6469    1
par[2] 0.625   0.002 0.124 0.407 0.537 0.618 0.705 0.889  6660    1

Samples were drawn using NUTS(diag_e) at Tue Feb 27 02:02:18 2024.
...
post-warmup draws per chain=2000, total post-warmup draws=8000.
        ...
        mean se_mean    sd  2.5%   25%   50%   75% 97.5% n_eff Rhat
par[1] 1.971   0.001 0.075 1.826 1.918 1.972 2.022 2.116 11525    1
par[2] 0.537   0.001 0.056 0.441 0.498 0.533 0.571 0.660 10101    1

Samples were drawn using NUTS(diag_e) at Tue Feb 27 02:02:25 2024.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
```
...
post-warmup draws per chain=2000, total post-warmup draws=8000.
        ...
        mean se_mean    sd  2.5%   25%   50%   75%  97.5% n_eff Rhat
par[1] 2.588   0.003 0.291 2.033 2.388 2.579 2.779  3.178  8117    1
par[2] 9.069   0.006 0.532 8.072 8.708 9.057 9.410 10.162  7834    1

Samples were drawn using NUTS(diag_e) at Tue Feb 27 02:02:10 2024.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
```
...
Estimate 264.828134 270.15640 279.47005
SE         9.033561  12.16038  14.44951
```
...
```{.output}
       weibull    gamma lognormal
2.5%  7.160701 7.026904  7.155187
50%   8.051781 7.977683  8.277368
97.5% 9.036671 9.058713  9.802142
```
...
```{.output}
       weibull    gamma lognormal
2.5%  2.810943 2.923958  3.561417
50%   3.334650 3.593261  4.734118
97.5% 4.142555 4.560286  6.805288
```
...
2.5%  1.412929 1.993634 6.865273 12.38539 13.36489 14.45660
50%   2.181387 2.866257 7.865025 13.84515 15.00864 16.35457
97.5% 2.985910 3.738627 8.859006 16.04839 17.64251 19.50630
```
...
```{.output}
         0.025     0.05      0.5     0.95    0.975     0.99
2.5%  1.793958 2.301751 6.491852 12.71547 14.13727 15.86663
50%   2.557483 3.110297 7.437657 14.65258 16.39417 18.60247
97.5% 3.303374 3.871443 8.439026 17.37844 19.67257 22.60961
```
...
```{.output}
         0.025     0.05      0.5     0.95    0.975     0.99
2.5%  1.872793 2.283365 6.206790 14.13183 16.33206 19.29064
50%   2.531963 2.993510 7.186094 17.23017 20.38082 24.76960
97.5% 3.160818 3.655460 8.293785 22.31122 27.22447 34.50549
```
