...
El objetivo de restar el número efectivo de parámetros del modelo es dar cuenta de la posibilidad de sobreajustar el modelo (*overfitting*). El WAIC nos permite caracterizar la capacidad predictiva del modelo: cuanto más bajo sea su valor, mejor. Es posible estimar el WAIC de cada modelo por medio de la función `waic` del paquete `loo`:

```{r}
fit <- list(constant = m1_chik, normal = m2_chik, normal_log = m3_chik)

waic <- mapply(
  function(z) {
    loo::waic(loo::extract_log_lik(
      z,
      parameter_name = "logLikelihood"
    ))$estimates[3, ]
  },
  fit
)
...
De acuerdo con este criterio, ¿cuál modelo se ajusta mejor a los datos?
...
- <https://epiverse-trace.github.io/epimodelac/data/virus_01.RDS>
- <https://epiverse-trace.github.io/epimodelac/data/virus_02.RDS>
- <https://epiverse-trace.github.io/epimodelac/data/virus_03.RDS>
- <https://epiverse-trace.github.io/epimodelac/data/virus_04.RDS>
...
Para adaptar la base de datos al formato necesario para {serofoi}, puede usar el siguiente código:
