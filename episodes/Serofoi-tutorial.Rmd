...
chik_constant <- fit_seromodel(serodata = chik2015p,
                               foi_model = "constant",
                               iter = 1000)
...
m1_chik <- fit_seromodel(serodata = chik2015p,
                         foi_model = "constant",
                         iter = 1000)

m2_chik <- fit_seromodel(serodata = chik2015p,
                         foi_model = "tv_normal",
                         iter = 1500)

m3_chik <- fit_seromodel(serodata = chik2015p,
